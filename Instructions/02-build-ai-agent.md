...
1. Open VS Code and **Clone** the following Git repo: [https://github.com/MicrosoftLearning/mslearn-ai-agents.git](https://github.com/MicrosoftLearning/mslearn-genaiops.git)
